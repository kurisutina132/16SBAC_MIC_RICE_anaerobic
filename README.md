# 16SBAC_MIC_RICE_anaerobic
Phyloseq 16S Bacteria
...
#objeto phyloseq library(phyloseq)
...
# Definimos taxa a filtrar de forma manual
...
#letras de significancia Tukey test
library(agricolae)
...
hist(richness$ACE, main="ACE index", xlab="")

hist(richness$Simpson, main="Simpsom index", xlab="")
...
####################################################################################
#Análisis de abundancia diferencial de microorganismos
library(devtools)
...
#extraer tablas de abundancias y boxplot de abundancias lefse
...
phyloseq::psmelt(pss_3) %>%
  ...
  facet_wrap(~ OTU, scales = "free")
####################################################################################
#ASV abundancias vs tratamientos
